...
!!repetitive!!The ATD Data Lake Architecture has the following essential components:
...
The `data_lake_catalog_pkey` key is created to prevent duplicate entries. It is also necesary for use within PostgREST to facilitate upserts. !!should this be upset?!!
...
* "Loop 360" $\iff$ "CAPITAL OF TEXAS HIGHWAY" !!is $\iff$ what should be showing here?!!
